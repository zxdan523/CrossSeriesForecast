...
class Model:
    ...
    def save_model_params(self, save_path):
        ...
        model_params['n_estimators'] = self.n_estimators
        model_params['criterion'] = self.criterion
        model_params['max_depth'] = self.max_depth
        model_params['min_samples_split'] = self.min_samples_split
        model_params['min_samples_leaf'] = self.min_samples_leaf
        model_params['max_features'] = self.max_features
    ...
    def show_model_params(self):
        ...
        print('n_estimators:' + str(self.n_estimators))
        print('criterion:' + str(self.criterion))
        print('max_depth:' + str(self.max_depth))
        print('min_samples_split:' + str(self.min_samples_split))
        print('min_samples_leaf:' + str(self.min_samples_leaf))
