...
from Forecast import RandomForest
...
test_years = [2015]
name = 'M5_' + dept_id + '_' + store_id + '_RF_global'

base_path = '../data/M5/' + dept_id + '_' + store_id + '/RF/global'
...
for idx, group in enumerate(groups):
    ...
    rf.set_model_params(init_model_params)
